 ...
 public:
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status Fetch(::grpc::ClientContext* context, const ::backend::FetchRequest& request, ::backend::FetchReply* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::backend::FetchReply>> AsyncFetch(::grpc::ClientContext* context, const ::backend::FetchRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::backend::FetchReply>>(AsyncFetchRaw(context, request, cq));
    }
  ...
  private:
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::backend::FetchReply>* AsyncFetchRaw(::grpc::ClientContext* context, const ::backend::FetchRequest& request, ::grpc::CompletionQueue* cq) = 0;
  ...
  class Stub GRPC_FINAL : public StubInterface {
   public:
    ...
    ::grpc::Status Fetch(::grpc::ClientContext* context, const ::backend::FetchRequest& request, ::backend::FetchReply* response) GRPC_OVERRIDE;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::backend::FetchReply>> AsyncFetch(::grpc::ClientContext* context, const ::backend::FetchRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::backend::FetchReply>>(AsyncFetchRaw(context, request, cq));
    }
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::backend::FetchReply>* AsyncFetchRaw(::grpc::ClientContext* context, const ::backend::FetchRequest& request, ::grpc::CompletionQueue* cq) GRPC_OVERRIDE;
  ...
  class Service : public ::grpc::SynchronousService {
   public:
    ...
    virtual ~Service();
    virtual ::grpc::Status Fetch(::grpc::ServerContext* context, const ::backend::FetchRequest* request, ::backend::FetchReply* response);
  ...
  class AsyncService GRPC_FINAL : public ::grpc::AsynchronousService {
   public:
    ...
    ~AsyncService() {};
    void RequestFetch(::grpc::ServerContext* context, ::backend::FetchRequest* request, ::grpc::ServerAsyncResponseWriter< ::backend::FetchReply>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag);
